...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewImage.setImageResource(R.drawable.preview_img_3);
        ...
        LinearLayout dialogFon2 = dialogEnd.findViewById(R.id.dialog_fon);
        dialogFon2.setBackgroundResource(R.drawable.preview_background_3);
        ...
        btnBack.setBackgroundResource(R.drawable.button_stroke_black_opaity_press_white);
